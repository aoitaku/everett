...
export type ShowPictureParameters = [number, string, number, boolean, number, number, number, number, number, number]
export type MovePictureParameters = [number, null, number, boolean, number, number, number, number, number, number, number, boolean]
